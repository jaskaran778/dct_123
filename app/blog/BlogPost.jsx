  ...
  const blogContent = {
    "machine-learning-perspectives": {
      ...
      content: `
        ...
        <h2 style="margin-top: 30px; margin-bottom: 20px; font-size: 24px; color: #333; font-weight: bold;">Machine Learning: A Data Science Process Perspectives</h2>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">When machine learning is seen as a process, the following definition is insightful:</h3>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Where machine learning is used in the data science process</h3>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Types of machine learning</h3>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Applications for machine learning in data science</h3>
        <ul style="margin-left: 20px; margin-bottom: 20px;">
...
<div style="display: flex; justify-content: center; margin-bottom: 20px;">
  ...
  <img src="/images/img4.jpeg" alt="SARS-CoV-2 cell entry" width="600" height="400" style="margin: 0 10px;" />
        ...
        <h2 style="margin-top: 30px; margin-bottom: 20px; font-size: 24px; color: #333; font-weight: bold;">Causes and Inner workings of the SARS-CoV-2</h2>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Mechanism of Infection</h3>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Immune Response</h3>
        ...
        <h3 style="margin-top: 30px; margin-bottom: 20px; font-size: 20px; color: #555; font-weight: bold;">Vaccines and Treatments</h3>
